...
def get_context_main_page(self, context):
    ...
    context['top_news'] = articles.order_by('-add_datetime')[:4]
    context['top_popular'] = articles.order_by('-rating')[:4]
    context['top_views'] = articles.order_by('-views')[:4]
    if not self.request.user.is_anonymous:
        ...
        context['recommend_articles_by_hub'] = articles_query_by_hub[:4]
        context['recommend_articles_by_author'] = articles_query_by_author[:4]
