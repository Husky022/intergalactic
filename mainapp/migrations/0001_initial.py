# Generated by Django 3.2.8 on 2021-10-10 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_datatime', models.DateField(default=django.utils.timezone.now, verbose_name='время добавления')),
                ...
                ('hab', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='mainapp.hab', verbose_name='Хаб')),
            ],
            options={
                'verbose_name': 'статья',
